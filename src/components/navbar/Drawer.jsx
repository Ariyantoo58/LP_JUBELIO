...
const platform =
  "https://jubelio.com/wp-content/uploads/2023/03/Jubelio-Omnichannel-1.svg";
...
export default function Drawers() {
  ...
  return (
    <Box>
      ...
      <Link href={"https://wa.me/082211429125"} mt={"50px"}>
        <Button bg={"#f7580a"} w={"70%"} mb={"20px"} color={"white"}>
          Jadwalkan Demo
        </Button>
      </Link>
    </Box>
