            ...
            {isDesktop ?
                <Box bg={"#F5FAFF"} >
                    <HStack w={'90%'} mx={'auto'} py={{ base: 0, lg: '30px' }}>
                        <Box>
                            <Image w={'300px'} mb={'30px'} src={'https://jubelio.com/wp-content/uploads/2023/03/Frame-7.svg'} />
                            <Heading mb={'30px'}> Balas pesan cepat pelanggan makin percaya</Heading>
                ...
                <Box bg={"#F5FAFF"} >
                    <Box w={'90%'} mx={'auto'}>
                        <Center>
                            <Image w={'350px'} h={'300px'} src={"https://jubelio.com/wp-content/uploads/2023/05/cover-jubelio-chat-1536x1536.png"} />
                        </Center>
                        <Box pb={'50px'}>
                            <Image w={'400px'} src={'https://jubelio.com/wp-content/uploads/2023/03/Frame-7.svg'} />
                            <Heading mb={'30px'}>Balas pesan cepat pelanggan makin percaya</Heading>
                            <Text mb={'30px'} >Interaksi tanpa jeda di semua channel jualan lewat satu platform.</Text>
                            <Button w={'150px'} h={'60px'} color={'white'} bg={'blue'} >Coba Gratis</Button>
                        </Box>
